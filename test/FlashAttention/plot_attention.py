...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Plot Attention Performance Comparisons")
    parser.add_argument("input_dir", nargs='?', default=".", help="Directory containing attention_TP.csv")
    ...
    for key, items in grouped_data.items():
        if is_prefill:
            ...
            title = (f"Decoding Comparison (BS={bs}, HQ={nh_q}, HKV={nh_kv}, "
        ...
        plt.plot(x_vals, y_gpu, marker='s', linestyle='-', label='GPU (Measured)', color='b', alpha=0.7)
