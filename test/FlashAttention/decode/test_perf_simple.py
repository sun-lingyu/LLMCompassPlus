...
if __name__ == "__main__":
    ...
    print(
        f"Batch size: {batch_size}, Seq len Q: {seq_len_q}, Seq len KV new: {seq_len_kv_new}, Seq len KV cached: {seq_len_kv_cached}, Num heads Q: {num_heads_q}, Num heads KV: {num_heads_kv}, Head dim: {head_dim}, Num splits: {num_splits}"
    )
    ...
    model = FlashAttentionDecode(
        ...
        intermediate_data_type=itermediate_data_type,
        pcb_module=pcb,
        is_causal=True,
