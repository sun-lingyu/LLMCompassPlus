...
if __name__ == "__main__":
    ...
    model = FlashAttentionPrefill(qkv_data_type=qkv_data_type, output_data_type=output_data_type, intermediate_data_type=intermediate_data_type, pcb_module=pcb, is_causal=True)
