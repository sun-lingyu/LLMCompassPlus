...
def run_marlin_benchmark(m, n, k, iterations=100, warmup=100, duration=0):
    ...
    for i in range(warmup):
        ...
        marlin.mul(A_list[rand_idx_A], B_list[rand_idx_B], C_list[rand_idx_C], s, workspace)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--duration", type=float, default=0.0, help="Minimum duration in ms (default: 0)")
