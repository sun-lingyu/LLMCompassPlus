...
class LaunchLatency:
    def __init__(
        self, matmul, layernorm, flashattn_prefill, flashattn_decode, flashattn_combine
    ):
        self.matmul = matmul
        self.layernorm = layernorm
        self.flashattn_prefill = flashattn_prefill
        self.flashattn_decode = flashattn_decode
